...
- [x] 3.1 `test_cleanup_dry_run_deletes_nothing` passes — 2c359fb
- [x] 3.2 `test_cleanup_deletes_idle_sessions` passes — 2c359fb
- [x] 3.3 `test_cleanup_preserves_fresh_sessions` passes — 2c359fb
- [x] 3.4 `cleanup_sessions --help` shows both flags — 2c359fb

#### Manual

- [x] 3.5 Two-session shell walk: dry-run preserves; real-run deletes only stale — 2c359fb
- [x] 3.6 `context/changes/game-session-models/README.md` operational note reads accurately — 2c359fb
